...
workflow REDUX_PROCESSING {
    ...
    ch_redux_out = WorkflowFastq2bam.groupByMeta(
        REDUX.out.bam,
    ...
    ch_redux_tumor_out = Channel.empty()
        .mix(
            WorkflowFastq2bam.restoreMeta(ch_redux_out_sorted.tumor, ch_inputs),
    ...
    ch_redux_normal_out = Channel.empty()
        .mix(
            WorkflowFastq2bam.restoreMeta(ch_redux_out_sorted.normal, ch_inputs),
    ...
    ch_redux_donor_out = Channel.empty()
        .mix(
            WorkflowFastq2bam.restoreMeta(ch_redux_out_sorted.donor, ch_inputs),
