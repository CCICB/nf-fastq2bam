...
Alignment functionality in `nf-fastq2bam` is simple and rigid, and exists only to meet the exact requirements of the
WiGiTS workflow.

#### BWA-MEM2

[BWA-MEM2](https://github.com/bwa-mem2/bwa-mem2) is a short-read mapping tool used to align reads to a large reference
sequences. In `nf-fastq2bam`, BWA-MEM2 is used to align DNA reads to the human genome.
